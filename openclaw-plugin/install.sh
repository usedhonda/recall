...
require_file "$SCRIPT_DIR/src/recall-settings.js"
require_file "$SCRIPT_DIR/src/settings-handler.js"
require_file "$SCRIPT_DIR/src/voice-transcript-handler.js"
...
run "cp '$SCRIPT_DIR/src/recall-settings.js' '$DEST_DIR/src/recall-settings.js'"
run "cp '$SCRIPT_DIR/src/settings-handler.js' '$DEST_DIR/src/settings-handler.js'"
run "cp '$SCRIPT_DIR/src/voice-transcript-handler.js' '$DEST_DIR/src/voice-transcript-handler.js'"
